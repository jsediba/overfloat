...
import { Direction, MouseButton, SimulationStep, simKeyPress, simKeyDown, simKeyUp, simMouseClick, simMouseDown, simMouseUp, simMouseScroll, simMouseMove, inputSimulation } from "../../src/services/InputSimulation";
...
const InputSimTester: React.FC = () => {
    ...
    const [mouseClick, setMouseClick] = useState<string>("");
        ...
        <div>
            ...
            <div className="container">
                <div className="row">
                    ...
                    <input type="text" className="col-4" onChange={(event) => setKeyPress(event.target.value)} />
                ...
                <div className="row">
                    ...
                    <input type="text" className="col-4" onChange={(event) => setKeyDown(event.target.value)} />
                    <button className="btn btn-primary col-2"
                        onClick={() => {
                ...
                <div className="row">
                    ...
                    <input type="text" className="col-4" onChange={(event) => setKeyUp(event.target.value)} />
                    <button className="btn btn-primary col-2"
                        onClick={() => {
                ...
                <div className="row">
                    ...
                    <select className="col-4" onChange={(event) => setMouseClick(event.target.value)}>
                    ...
                    <button className="btn btn-primary col-2"
                        onClick={() => {
                            addSimulationStep(simMouseClick(strToMouseButton(mouseClick)));
                ...
                <div className="row">
                    ...
                    <select className="col-4" onChange={(event) => setMouseDown(event.target.value)}>
                        <option value="Left">Left</option>
                        <option value="Middle">Middle</option>
                        <option value="Right">Right</option>
                    </select>
                    <button className="btn btn-primary col-2"
                        onClick={() => {
                            addSimulationStep(simMouseDown(strToMouseButton(mouseDown)));
                ...
                <div className="row">
                    ...
                    <select className="col-4" onChange={(event) => setMouseUp(event.target.value)}>
                        <option value="Left">Left</option>
                        <option value="Middle">Middle</option>
                        <option value="Right">Right</option>
                    </select>
                    <button className="btn btn-primary col-2"
                        onClick={() => {
                            addSimulationStep(simMouseUp(strToMouseButton(mouseUp)));
                ...
                <div className="row">
                    ...
                    <select className="col-4" onChange={(event) => setScroll(event.target.value)}>
                    ...
                    <button className="btn btn-primary col-2"
                        onClick={() => {
                            addSimulationStep(simMouseScroll(strToDirection(scroll)));
                ...
                <div className="row">
                    ...
                    <input className="col-2" type="number" defaultValue={x} onChange={(event) => setX(event.target.valueAsNumber)} />
                    <input className="col-2" type="number" defaultValue={y} onChange={(event) => setY(event.target.valueAsNumber)} />
                    <button className="btn btn-primary col-2"
                        onClick={() => {
            ...
            <div className="container">
                ...
                <div className="row">
                    <button className="btn btn-primary col-6" onClick={() => inputSimulation(sim)}>
                        Execute
                    </button>
                    <button className="btn btn-secondary col-6" onClick={() => {setSim([]); setSimStr([])}}>
                        Clear
                    </button>
                </div>
