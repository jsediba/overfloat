...
mkdir -p "overfloat.AppDir"
cp -r ../appimage_deb/data/usr "overfloat.AppDir"
...
( cd "/home/urcier/.cache/tauri" && ( wget -q -4 -N https://github.com/AppImage/AppImageKit/releases/download/continuous/AppRun-${ARCH} || wget -q -4 -N https://github.com/AppImage/AppImageKit/releases/download/12/AppRun-${ARCH} ) )
chmod +x "/home/urcier/.cache/tauri/AppRun-${ARCH}"

# We need AppRun to be installed as overfloat.AppDir/AppRun.
# Otherwise the linuxdeploy scripts will default to symlinking our main bin instead and will crash on trying to launch.
cp "/home/urcier/.cache/tauri/AppRun-${ARCH}" AppRun

cp "usr/share/icons/hicolor/256x256@2/apps/overfloat.png" .DirIcon
ln -sf "usr/share/icons/hicolor/256x256@2/apps/overfloat.png" "overfloat.png"

ln -sf "usr/share/applications/overfloat.desktop" "overfloat.desktop"
...
( cd "/home/urcier/.cache/tauri" && wget -q -4 -N https://raw.githubusercontent.com/tauri-apps/linuxdeploy-plugin-gtk/master/linuxdeploy-plugin-gtk.sh )
( cd "/home/urcier/.cache/tauri" && wget -q -4 -N https://github.com/tauri-apps/binary-releases/releases/download/linuxdeploy/linuxdeploy-${linuxdeploy_arch}.AppImage )

chmod +x "/home/urcier/.cache/tauri/linuxdeploy-plugin-gtk.sh"
chmod +x "/home/urcier/.cache/tauri/linuxdeploy-${linuxdeploy_arch}.AppImage"

dd if=/dev/zero bs=1 count=3 seek=8 conv=notrunc of="/home/urcier/.cache/tauri/linuxdeploy-${linuxdeploy_arch}.AppImage"

OUTPUT="overfloat_1.0.0_amd64.AppImage" "/home/urcier/.cache/tauri/linuxdeploy-${linuxdeploy_arch}.AppImage" --appimage-extract-and-run --appdir "overfloat.AppDir" --plugin gtk ${gst_plugin} --output appimage
