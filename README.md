...
-   `hideWindow(label)`
    -   Minimizes a window. Only works on windows from the same module.
	-	Parameters:
		-	[optional] label: string - Label of the window to be minimized. If not set, the window from where this function was called is minimized.

-	`showWindow(label)`
    -   Shows a window. Only works on windows from the same module.
	-	Parameters:
		-	[optional] label: string - Label of the window to be shown. If not set, the window from where this function was called is shown.

-   `closeWindow(label)`
    -   Closes a window. Only works on windows from the same module. Closing the main window of the module will result in the entire module closing.
	-	Parameters:
		-	[optional] label: string - Label of the window to be closed. If not set, the window from where this function was called is closed.
...
-   `async writeFile(content, path, useRelativePath, appendMode): Promise<FSResult>`
...
-   `async readFile(path, useRelativePath)`
...
-   `simKeyPress(key): SimulationStep`
...
-   `simMouseDown(button): SimulationStep`
...
-   `simMouseUp(button): SimulationStep`
...
-   `simMouseClick(button): SimulationStep`
...
-   `simMouseScroll(direction): SimulationStep`
...
-   `simMouseMove(x, y): SimulationStep`
